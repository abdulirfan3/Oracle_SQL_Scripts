...
--
--              sql_id: the sql_id of the statement if you know it 
--                      (leave blank to ignore or type "last" for last statement executed)
--                      note: serveroutput must be set to off for the "last" functionality
--
-- Description:
--
...
and sql_id like CASE WHEN '&&sql_id' = 'last' THEN 
