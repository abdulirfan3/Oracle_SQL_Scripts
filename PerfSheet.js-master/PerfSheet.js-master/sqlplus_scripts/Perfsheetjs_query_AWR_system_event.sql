--
-- Perfsheetjs_query_AWR_system_event.sql -> Extracts data from dba_hist_system_event. This provides information on all the wait events. 
-- The query computes delta values between snapshots and rates (i.e. delta values divided over delta time).
-- output is in csv format
-- Luca Canali, Oct 2012, last modified Jan 2016
--
...
set termout on
prompt 
prompt Dumping AWR data to file Perfsheetjs_AWR_system_event_&myfilesuffix..csv, please wait
prompt 
set termout off

spool Perfsheetjs_AWR_system_event_&myfilesuffix..csv
