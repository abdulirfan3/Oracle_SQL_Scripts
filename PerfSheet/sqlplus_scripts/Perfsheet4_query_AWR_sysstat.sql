...
-- Perfsheet4_query_AWR_sysstat.sql -> Extracts data from dba_hist_sysstat, computes delta values between snapshots and rates (i.e. delta values divided over delta time)
...
set termout on
prompt 
prompt Dumping AWR data to file Perfsheet4_AWR_sysstat_&myfilesuffix..csv, please wait
prompt 
set termout off

spool Perfsheet4_AWR_sysstat_&myfilesuffix..csv
