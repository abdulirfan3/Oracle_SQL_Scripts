--
-- Perfsheet4_query_AWR_system_event.sql -> Extracts data from dba_hist_system_event, computes delta values between snapshots and rates (i.e. delta values divided over delta time)
