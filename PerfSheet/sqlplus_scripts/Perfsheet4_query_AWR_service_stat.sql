...
-- Perfsheet4_query_AWR_service_stat.sql -> Extracts data from dba_hist_service_stat, computes delta values between snapshots and rates (i.e. delta values divided over delta time)
