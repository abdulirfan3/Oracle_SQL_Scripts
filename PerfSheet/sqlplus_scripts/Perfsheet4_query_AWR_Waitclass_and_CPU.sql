--
-- Perfsheet4_query_AWR_Waitclass_and_CPU.sql -> Extracts data from dba_hist_system_event and dba_hist_sysstat, computes delta values and rates (delta value over delta time) aggregating over wait class
