...
END as GRAPH 
from 
(select tablespace_name ts, sum(bytes)/1024/1024/1024 gb from dba_data_files group by tablespace_name) total, 
(select tablespace_name ts, sum(bytes)/1024/1024/1024 gb from dba_free_space group by tablespace_name) free, 
