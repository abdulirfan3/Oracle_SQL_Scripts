...
prompt
prompt Usage:              
prompt              @session_wait.sql <sid>
prompt              @session_wait.sql 52,110,225
prompt              @session_wait.sql "select sid from v$session where username = 'XYZ'"
prompt              @session_wait.sql "select sid from v$session where status ='ACTIVE' and type <> 'BACKGROUND'"
prompt
--------------------------------------------------------------------------------
