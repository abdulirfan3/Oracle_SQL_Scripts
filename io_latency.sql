...
*/
set termout off;
 column seq_ms for 99999999.99
   column seq_ct for 99999999.99
   column lfpw_ms for 99999999.99
   column lfpw_ct for 99999999.99
   column seq_ms for 99999999.99
   column scat_ct for 99999999.99
   column dpr_ms for 99999999.99
   column dpr_ct for 99999999.99
   column dprt_ms for 99999999.99
   column dprt_ct for 99999999.99
...
prompt
Prompt Look at script for what each column stands for...
Prompt The first execution of the query is I/O since database startup, so should most likely be ignored.
Prompt Subsequent executions are the I/O since the last execution
