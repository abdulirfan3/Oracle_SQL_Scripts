...
SET TRIMSPOOL ON
SET VERIFY   off
COLUMN H00   FORMAT 99999     HEADING '00'
COLUMN H01   FORMAT 99999     HEADING '01'
COLUMN H02   FORMAT 99999     HEADING '02'
COLUMN H03   FORMAT 99999     HEADING '03'
COLUMN H04   FORMAT 99999     HEADING '04'
COLUMN H05   FORMAT 99999     HEADING '05'
COLUMN H06   FORMAT 99999     HEADING '06'
COLUMN H07   FORMAT 99999     HEADING '07'
COLUMN H08   FORMAT 99999     HEADING '08'
COLUMN H09   FORMAT 99999     HEADING '09'
COLUMN H10   FORMAT 99999     HEADING '10'
COLUMN H11   FORMAT 99999     HEADING '11'
COLUMN H12   FORMAT 99999     HEADING '12'
COLUMN H13   FORMAT 99999     HEADING '13'
COLUMN H14   FORMAT 99999     HEADING '14'
COLUMN H15   FORMAT 99999     HEADING '15'
COLUMN H16   FORMAT 99999     HEADING '16'
COLUMN H17   FORMAT 99999     HEADING '17'
COLUMN H18   FORMAT 99999     HEADING '18'
COLUMN H19   FORMAT 99999     HEADING '19'
COLUMN H20   FORMAT 99999     HEADING '20'
COLUMN H21   FORMAT 99999     HEADING '21'
COLUMN H22   FORMAT 99999     HEADING '22'
COLUMN H23   FORMAT 99999     HEADING '23'
