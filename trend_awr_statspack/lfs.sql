...
from dba_hist_snapshot dhs, sys.wrh$_system_event se, v$event_name en
...
from sys.wrh$_system_event se, v$event_name en
...
from sys.wrh$_sysstat ss, sys.wrh$_stat_name sn, v$instance v
...
from sys.wrh$_event_histogram eh, v$event_name en
